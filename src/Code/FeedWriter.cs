	...
	public class FeedWriter
	{
		public string GetFeed(string baseUrl, params Package[] packages)
		{
			...
			using (XmlWriter writer = XmlWriter.Create(sb, settings))
			{
				...
				writer.WriteElementString("title", "SSMS VSIX Gallery");
				...
				writer.WriteElementString("subtitle", "Add this feed to SQL Server Management Studio's extension manager from Tools -> Options -> Environment -> Extensions and Updates");
